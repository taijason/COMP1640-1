                          ...
                          <nav id="main-nav" data-animate="menu-in menu-out">
                              <ul class="main-navigation">
                                  ...
                                  <li class="nav-item d_none">
                                    <a class="nav-link" href="{{url('list')}}">Admin</a>
                                 </li>
                                 <li class="nav-item d_none">
                                    <a class="nav-link" href="{{url('list2')}}">Comment</a>
                                 </li>
            ...
            <div class="a-slide slide2">
                <div class="container">
                    <div class="bottom-section">
                        <h1 class="header-txt">Giá điện thoại rẻ nhất trong vũ trụ</h1>
                        <div class="divider">
                            <?xml version="1.0" encoding="utf-8"?>
                            <!-- Generator: Adobe Illustrator 21.1.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1930 255.5" style="enable-background:new 0 0 1930 255.5;" xml:space="preserve">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4 margin_bottom1">
                            <div class="product_box">
                               <figure><img src="images/products/{{$row->productImage1}}"
                                    alt="#" height="160px" width="160px"/></figure>
                               <h3>{{$row->ideaName}}</h3>
                            </div>
                         </div>
                        @endforeach
                       ...
                       <footer id="contact-us">
                           <div class="container">
                               ...
                               <!--.footer-content-->
                               <p class="copy-info">Copyright 2022© by Duong Kien Dat and Ngo Tien Phat</p>
                           </div>
                           <!--.container-->
                       </footer>
