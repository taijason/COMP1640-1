...
<body>
            ...
            <div class="a-slide slide1">
                <div class="container">
                    <div class="bottom-section scroll-reveal" data-origin="right" data-distance="20%">
                        <h1 class="header-txt">Điện thoại uy tín, chất lượng nhất ở Việt Nam</h1>
                        <div class="divider">
            ...
            <div class="a-slide slide2">
                <div class="container">
                    <div class="bottom-section">
                        <h1 class="header-txt">Idea Pricest</h1>
                        <div class="divider">
                            <?xml version="1.0" encoding="utf-8"?>
                            <!-- Generator: Adobe Illustrator 21.1.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1930 255.5" style="enable-background:new 0 0 1930 255.5;" xml:space="preserve">
    ...
    <section id="specials-grid" class="month-specials" data-scroll-reveal="enter from the bottom after 0.9s">
        <div class="product">
            <div class ="container">
            <h1 class="header-txt">Idea hot</h1>
            <div class="divider">
                <?xml version="1.0" encoding="utf-8"?>
                <!-- Generator: Adobe Illustrator 21.1.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1930 255.5" style="enable-background:new 0 0 1930 255.5;" xml:space="preserve">
            ...
            <div class="col-md-12">
                <div class="our_products">
                    ...
                    <div class="special-img">
                        <img src="images/products/{{$row->ideaImage1}} " height="160px" width="160px"/>
                    </div>
                    <div class="special-items">
                        <h2 class="scroll-reveal" data-origin="top" data-distance="20%">{{$row->ideaName}}</h2>
                        <span class="line scroll-reveal" data-origin="top" data-distance="20%"></span>
                        <p class="scroll-reveal" data-origin="bottom" data-distance="30%">{{$row->ideaID}}</p>
                        <span class="scroll-reveal" data-origin="bottom" data-distance="60%">${{$row->ideaPrice}}</span>
                    </div>
                    @endforeach
                </div>
                <!--.special-->
    ...
    <footer id="contact-us">
        <div class="container">
            ...
            <!--.footer-content-->
            <p class="copy-info">Copyright 2023© by Group 22</p>
        </div>
        <!--.container-->
    </footer>
